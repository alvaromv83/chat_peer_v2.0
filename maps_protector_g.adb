-- Código proporcionado por Universidad Rey Juan Carlos
...
package body Maps_Protector_G is
   ...
   protected body Prot_Map is
	 ...
	 return Maps.Map_Length(Map);
  	 	...
  	 	function Max_Length_Value return Natural is	-- Añadida por mí
   	begin
    return Maps.Max_Length_Value(Map);
   ...
   function Max_Length_Value (M : Prot_Map) return Natural is  -- Añadida por mí
   begin
   	return M.Max_Length_Value;
   end Max_Length_Value;
